...
//        $(canvas_id)[0].width = 280
//        $(canvas_id)[0].height = 280
    }

    this.get_image_data_full = function(){
        var ctx = get_ctx();
...
function smart_paint_widget(canvas_id){
    ...
    var pressure_width = false  // Change width of strokes dep on pressure?
    ...
    this.draw_line = function(line) {
        ...
        if (pressure_width) {
            ...
            line.width = 20 // todo use defaults
        }
    ...
    this.get_image_data_full = canvas.get_image_data_full
    this.ctx = canvas.ctx;
}
...
//        $(canvas_id).css('height',280)
//        $(canvas_id).css('width', 280)
//        canvas.ctx().scale(0.1,0.1);
    }
